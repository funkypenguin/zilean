...
fn test_languages_detection() {
    let test_cases = vec![
        ("Deadpool 2016 1080p BluRay DTS Rus Ukr 3xEng HDCL", vec![
            Language::Russian,
            Language::Ukrainian,
        ]),
        ("VAIANA: MOANA (2017) NL-Retail [2D] EAGLE", vec![
            Language::Dutch,
        ]),
        (
            "De Noodcentrale S02E05 FLEMISH 540p WEBRip AAC H 264",
            vec![Language::Dutch],
        ),
        (
        ...
        ("127.Heures.FRENCH.DVDRip.AC3.XViD-DVDFR", vec![
            Language::French,
        ]),
        ("Color.Of.Night.Unrated.DC.VostFR.BRrip.x264", vec![
            Language::French,
        ]),
        (
            "Le Labyrinthe 2014 Multi-VF2 1080p BluRay x264-PopHD",
            vec![Language::French],
        ),
        (
        ...
        ("South.Park.S21E10.iTALiAN.FiNAL.AHDTV.x264-NTROPiC", vec![
            Language::Italian,
        ]),
        ("2- English- {SDH}.srt", vec![Language::English]),
        ("1_ English-Subs.srt", vec![Language::English]),
        ("House S 1 CD 1-6 svensk, danska, norsk, finsk sub", vec![
            Language::Danish,
            Language::Finnish,
            Language::Swedish,
            Language::Norwegian,
        ]),
        ("Svein.Og.Rotta.NORSK.Nordic.Subs.2006", vec![
            Language::Danish,
            Language::Finnish,
            Language::Swedish,
            Language::Norwegian,
        ...
        (
            ...
            vec![Language::French, Language::Swedish],
        ),
        (
            "A.Good.Day.To.Die.Hard.2013.SWESUB.DANSUB.FiNSUB.720p.WEB-DL.-Ro",
            vec![Language::Danish, Language::Finnish, Language::Swedish],
        ),
        (
        ...
        ("Royal.Pains.S05E02.HDTV.subtitulado.esp.sc.avi", vec![
            Language::Spanish,
        ]),
        ("Desmembrados (2006) [HDrip-XviD-AC3][Castellano]", vec![
            Language::Spanish,
        ]),
        ...
        ("Los.Vengadores.DVDR español ingles clon", vec![
            Language::English,
            Language::Spanish,
        ]),
        (
        ...
        ("Mary Poppins Returns 2019 DVDRip LATINO-1XBET", vec![
            Language::LatinAmericanSpanish,
        ]),
        ("Los Simpsons S18 E01 Latino", vec![
            Language::LatinAmericanSpanish,
        ]),
        (
        ...
        (
            ...
            vec![Language::English, Language::LatinAmericanSpanish],
        ),
        ("Dumbo.2019.1080p.Dual.Lat", vec![
            Language::LatinAmericanSpanish,
        ]),
        ("A.Score.to.Settle.2019.lati.mp4", vec![
            Language::LatinAmericanSpanish,
        ]),
        (
            "[S0.E04] Gambit królowej - Gra środkowa.Spanish Latin America.srt",
            vec![Language::LatinAmericanSpanish],
        ),
        ("Latin American.spa.srt", vec![
            Language::LatinAmericanSpanish,
        ]),
        ("Men in Black International 2019 (inglês português)", vec![
            Language::English,
            Language::Portuguese,
        ]),
        (
            "Assassins (1995) Sylvester Stallone.DVDrip.XviD - Italian Englis",
            vec![Language::English, Language::Italian],
        ),
        ("El Club de la Lucha[dvdrip][spanish]", vec![
            Language::Spanish,
        ]),
        (
        ...
        ("Inception 2010 1080p BRRIP[dual-audio][eng-hindi]", vec![
            Language::English,
            Language::Hindi,
        ]),
        ("Inception (2010) 720p BDRip Tamil+Telugu+Hindi+Eng", vec![
            Language::English,
            Language::Hindi,
            Language::Telugu,
            Language::Tamil,
        ]),
        ("Subs/Dear.S01E02.WEBRip.x265-ION265/34_tam.srt", vec![
            Language::Tamil,
        ]),
        ("Subs/Dear.S01E02.WEBRip.x265-ION265/35_tel.srt", vec![
            Language::Telugu,
        ]),
        ("Dabangg 3 2019 AMZN WebRip Hindi 720p x264", vec![
            Language::Hindi,
        ]),
        (
        ...
        ("The Mandalorian S01E06 POLISH WEBRip x264-FLAME", vec![
            Language::Polish,
        ]),
        ("Carros 2 Dublado - Portugues BR (2011)", vec![
            Language::Portuguese,
        ]),
        (
            "A.Simple.Plan.1998.720p.BDRIP.X264.dublado.portugues.BR.gmenezes",
            vec![Language::Portuguese],
        ),
        ("American.Horror.Story.S01E01.720p. PORTUGUÊS BR", vec![
            Language::Portuguese,
        ]),
        ("Angel.S05E19.legendado.br.rmvb", vec![Language::Portuguese]),
        ("Grimm S01E11 Dublado BR [ kickUploader ]", vec![
            Language::Portuguese,
        ]),
        ("InuYasha.EP161.ptBR.subtitles.[inuplace.com.br].avi", vec![
            Language::Portuguese,
        ]),
        ("Ghost.Rider.DivX_Gamonet(Ingles-Port.BR)-AC3.avi", vec![
            Language::English,
            Language::Portuguese,
        ]),
        ("I Am David  legendado pt/br", vec![Language::Portuguese]),
        ("Lone Wolf and Cub 6 movies - legendas BR", vec![
            Language::Portuguese,
        ]),
        (
            "Wonder Woman Season 3 (H.264 1080p; English/Portuguese-BR)",
            vec![Language::English, Language::Portuguese],
        ),
        (
            "MIB 3 - Homens de Preto 2012 ( Audio EN-BR - Leg BR  Mkv 1280x69",
            vec![Language::English, Language::Portuguese],
        ),
        ("my wife is a gangster 3 legendado em PT(BR)", vec![
            Language::Portuguese,
        ]),
        (
        ...
        ("Superman I - O Filme 1978 Leg. BR - Mkv 1280x528", vec![
            Language::Portuguese,
        ]),
        ...
        (
            ...
            vec![Language::Japanese, Language::Portuguese],
        ),
        ("Zola Maseko - Drum (2004) PT subs", vec![
            Language::Portuguese,
        ]),
        ("Idrissa Ouedraogo - Yaaba (1989) EN ES FR PT", vec![
            Language::English,
            Language::French,
            Language::Spanish,
        ]),
        ("Metallica.Through.The.Never.2013 O Filme(leg.pt-pt)", vec![
            Language::Portuguese,
        ]),
        ("Dinossauro (2000) --[ Ing / Pt / Esp ]", vec![
            Language::English,
            Language::Spanish,
        ]),
        ("The Guard 2011.DK.EN.ES.HR.NL.PT.RO.Subtitles", vec![
            Language::English,
            Language::Spanish,
            Language::Romanian,
            Language::Croatian,
        ...
        ("Subs(ara,fre,ger).srt", vec![
            Language::French,
            Language::German,
            Language::Arabic,
        ]),
        ("Subs(chi,eng,ind,kor,may,tha,vie).srt", vec![
            Language::English,
            Language::Korean,
            Language::Chinese,
            Language::Vietnamese,
        ...
        (
            ...
            vec![Language::English, Language::Romanian],
        ),
        ...
        ("Pasienio sargyba S01E03 (2016 WEBRip LT)", vec![
            Language::Lithuanian,
        ]),
        ...
        ("Initial D Live Action 2005 ENG/CHI", vec![
            Language::English,
            Language::Chinese,
        ]),
        (
            "Wolf.Warrior.2015.720p.BluRay.x264.Mandarin.AAC-ETRG",
            vec![Language::Chinese],
        ),
        ("Traditional Chinese.chi.srt", vec![Language::Chinese]),
        ("Subs/Promare - Chinese (Traditional).ass", vec![
            Language::Chinese,
        ]),
        ("Berserk 01-25 [dual audio JP,EN] MKV", vec![
            Language::English,
            Language::Japanese,
        ]),
        (
        ...
        ("Shinjuku Swan 2015 JAP 1080p BluRay x264 DTS-JYK", vec![
            Language::Japanese,
        ]),
        (
        ...
        ("The.Nun.2018.KORSUB.HDRip.XviD.MP3-STUTTERSHIT", vec![
            Language::Korean,
        ]),
        ("Burning.2018.KOREAN.720p.BluRay.H264.AAC-VXT", vec![
            Language::Korean,
        ]),
        (
            "Atonement.2017.KOREAN.ENSUBBED.1080p.WEBRip.x264-VXTT",
            vec![Language::English, Language::Korean],
        ),
        ("A Freira (2018) Dublado HD-TS 720p", vec![
            Language::Portuguese,
        ]),
        (
        ...
        (
            "arsenico por compasion 1944 Capra spanish castellano",
        ...
        ("Geminis.2005.Argentina.ESP.ENG.PT.SUBS", vec![
            Language::English,
            Language::Spanish,
            Language::Portuguese,
        ]),
        ...
        ("The Adams Family (1991) (Greek Subs integratet)", vec![
            Language::Greek,
        ]),
        ("6_Greek.srt", vec![Language::Greek]),
        ("The Insult (2017) [BluRay] [720p] Arabic", vec![
            Language::Arabic,
        ]),
        ("The.Mexican.2001 - Arabic Subs Hardcoded", vec![
            Language::Arabic,
        ]),
        (
        ...
        ("42.2013.720p.BluRay.x264.HD4Ar Arab subtitle", vec![
            Language::Arabic,
        ]),
        (
        ...
        ("The.Protector.2018.S03.TURKISH.WEBRip.x264-ION10", vec![
            Language::Turkish,
        ]),
        (
            "Recep Ivedik 6 (2020) NETFLIX 720p WEBDL (Turkish) - ExtremlymTorrents",
            vec![Language::Turkish],
        ),
        (
        ...
        (
            "www.1TamilMV.cz - Mirzapur (2020) S02 EP (01-10) - HQ HDRip - [Tam+ Tel] - x264 - AAC - 1GB - ESub",
            vec![Language::English, Language::Telugu, Language::Tamil],
        ),
        (
            "www.1TamilMV.cz - The Game of Chathurangam (2023) WEB-DL - 1080p - AVC - (AAC 2.0) [Tamil + Malayalam] - 1.2GB.mkv",
            vec![Language::Tamil, Language::Malayalam],
        ),
        (
            "www.1TamilMV.yt - Anchakkallakokkan (2024) Malayalam HQ HDRip - 720p - HEVC - (DD+5.1 - 192Kbps & AAC) - 750MB - ESub.mkv",
            vec![Language::English, Language::Malayalam],
        ),
        (
        ...
        (
            ...
            vec![Language::Bengali],
        ),
        (
            "Kingdom.of.the.Planet.of.the.Apes.2024.HDRIP.1080P.[xDark [SaveHD] Latin + English + Hindi.mp4",
            vec![
                Language::English,
                Language::LatinAmericanSpanish,
                Language::Hindi,
        ...
        (
            "The Karate Kid Part III 1989 1080p DUAL TİVİBU WEB-DL x264 AAC - HdT",
            vec![Language::Turkish],
        ),
    ];
