...
fn test_audio_detection() {
    let test_cases = vec![
        ...
        ("Gold 2016 1080p BluRay DTS-HD MA 5 1 x264-HDH", vec![
            "DTS Lossless",
        ]),
        ("Rain Man 1988 REMASTERED 1080p BRRip x264 AAC-m2g", vec![
            "AAC",
        ]),
        (
        ...
        ("Jimmy Kimmel 2017 05 03 720p HDTV DD5 1 MPEG2-CTL", vec![
            "Dolby Digital",
        ]),
        ("A Dog's Purpose 2016 BDRip 720p X265 Ac3-GANJAMAN", vec![
            "AC3",
        ]),
        ...
        ("Monk.S01.1080p.AMZN.WEBRip.DDP2.0.x264-AJP69[rartv]", vec![
            "Dolby Digital Plus",
        ]),
        ("Monk.S01E01E02.1080p.WEB-DL.DD2.0.x264-AJP69.mkv", vec![
            "Dolby Digital",
        ]),
        (
...
fn test_audio_detection_without_episode() {
    ...
    for (input, expected_audio) in test_cases {
        ...
        assert!(
            ...
            "Unexpected episode detection for {}",
            input
        );
    }
}
...
fn test_dts_separation() {
    let test_cases = vec![
        (
            "The Shawshank Redemption 1994.MULTi.1080p.Blu-ray.DTS-HDMA.5.1.HEVC-DDR[EtHD]",
            vec!["DTS Lossless"],
            "The Shawshank Redemption",
        ),
        (
            "Oppenheimer.2023.BluRay.1080p.DTS-HD.MA.5.1.AVC.REMUX-FraMeSToR.mkv",
            vec!["DTS Lossless"],
            "Oppenheimer",
        ),
        (
            "Guardians.of.the.Galaxy.Vol.3.2023.BluRay.1080p.DTS-HD.MA.7.1.x264-MTeam[TGx]",
            vec!["DTS Lossless"],
            "Guardians of the Galaxy Vol 3",
        ),
        (
            "Oppenheimer.2023.2160p.MA.WEB-DL.DUAL.DTS.HD.MA.5.1+DD+5.1.DV-HDR.H.265-TheBiscuitMan.mkv",
            vec!["DTS Lossless", "Dolby Digital Plus"],
            "Oppenheimer",
        ),
        (
            "The.Equalizer.3.2023.BluRay.1080p.DTS-HD.MA.5.1.x264-MTeam",
            vec!["DTS Lossless"],
            "The Equalizer 3",
        ),
        (
            "Point.Break.1991.2160p.Blu-ray.Remux.DV.HDR.HEVC.DTS-HD.MA.5.1-CiNEPHiLES.mkv",
            vec!["DTS Lossless"],
            "Point Break",
        ),
        (
            "The.Mechanic.2011.2160p.UHD.Blu-ray.Remux.DV.HDR.HEVC.DTS-HD.MA.5.1-CiNEPHiLES.mkv",
            vec!["DTS Lossless"],
            "The Mechanic",
        ),
        (
            "Face.Off.1997.UHD.BluRay.2160p.DTS-HD.MA.5.1.DV.HEVC.REMUX-FraMeSToR.mkv",
            vec!["DTS Lossless"],
            "Face Off",
        ),
        (
            "Killers of the Flower Moon 2023 2160p UHD Blu-ray Remux HEVC DV DTS-HD MA 5.1-HDT.mkv",
            vec!["DTS Lossless"],
            "Killers of the Flower Moon",
        ),
        (
            "Ghostbusters.Frozen.Empire.2024.1080p.BluRay.ENG.LATINO.HINDI.ITA.DTS-HD.Master.5.1.H264-BEN.THE.MEN",
            vec!["DTS Lossless"],
            "Ghostbusters Frozen Empire",
        ),
        (
            "How.To.Train.Your.Dragon.2.2014.1080p.BluRay.ENG.LATINO.DTS-HD.Master.H264-BEN.THE.MEN",
            vec!["DTS Lossless"],
            "How To Train Your Dragon 2",
        ),
        (
            "【高清影视之家发布 www.HDBTHD.com】奥本海默[IMAX满屏版][简繁英字幕].Oppenheimer.2023.IMAX.2160p.BluRay.x265.10bit.DTS-HD.MA.5.1-CTRLHD",
            vec!["DTS Lossless"],
            "高清影视之家发布",
        ),
        (
            "Ocean's.Thirteen.2007.UHD.BluRay.2160p.DTS-HD.MA.5.1.DV.HEVC.HYBRID.REMUX-FraMeSToR.mkv",
            vec!["DTS Lossless"],
            "Ocean's Thirteen",
        ),
        (
            "Sleepy.Hollow.1999.BluRay.1080p.2Audio.DTS-HD.HR.5.1.x265.10bit-ALT",
            vec!["DTS Lossy"],
            "Sleepy Hollow",
        ),
        (
        ...
        (
            "Indiana Jones and the Last Crusade 1989 BluRay 1080p DTS AC3 x264-MgB",
            vec!["DTS Lossy", "AC3"],
            "Indiana Jones and the Last Crusade",
        ),
        (
            "2012.London.Olympics.BBC.Bluray.Set.1080p.DTS-HD",
            vec!["DTS Lossy"],
            "London Olympics BBC",
        ),
        (
            "www.1TamilMV.phd - Oppenheimer (2023) English BluRay - 1080p - x264 - (DTS 5.1) - 7.3GB - ESub.mkv",
            vec!["DTS Lossy"],
            "Oppenheimer",
        ),
        (
            "【高清影视之家发布 www.HDBTHD.com】年会不能停！[60帧率版本][国语音轨+中文字幕].Johnny.Keep.Walking.2023.60FPS.2160p.WEB-DL.H265.10bit.DTS.5.1-GPTHD",
            vec!["DTS Lossy"],
            "高清影视之家发布",
        ),
        (
            "Big.Stan.2007.1080p.BluRay.Remux.DTS-HD.HR.5.1",
            vec!["DTS Lossy"],
            "Big Stan",
        ),
        (
            "Ditched.2022.1080p.Bluray.DTS-HD.HR.5.1.X264-EVO[TGx]",
            vec!["DTS Lossy"],
            "Ditched",
        ),
        (
