...
fn test_quality_detection() {
    let test_cases = vec![
        ...
        (
            "Brown Nation S01E05 1080p WEBRip x264-JAWN",
            Quality::WebRip,
        ),
        (
        ...
        (
            "My.Super.Ex.Girlfriend.FRENCH.TELECINE.XViD-VCDFRV",
            Quality::TeleCine,
        ),
        ("You're Next (2013) cam XVID", Quality::Cam),
        (
            "Shes the one_2013(camrip)__TOPSIDER [email protected]",
            Quality::Cam,
        ),
        ...
        (
            "The.Mysteries.of.Pittsburgh.LIMITED.SCREENER.XviD-COALiTiON [NOR",
            Quality::SCR,
        ),
        (
            "El.curioso.caso.de.benjamin.button-BRScreener-[EspaDivx.com].rar",
            Quality::SCR,
        ),
        (
        ...
        (
            "Vampire in Vegas (2009) NL Subs DVDR DivXNL-Team",
            Quality::DVD,
        ),
        (
        ...
        (
            "Joker.2019.UHD.BluRay.2160p.TrueHD.Atmos.7.1.HEVC.REMUX-JAT",
            Quality::BluRayRemux,
        ),
        (
        ...
        (
            "Son of God 2014 HDR BDRemux 1080p.mkv",
            Quality::BluRayRemux,
        ),
        (
        ...
        (
            "Мужчины без женщин (Альгимантас Видугирис) [1981, Драма, VHS]",
            Quality::VHS,
        ),
        (
        ...
        (
            "Соперницы (Алексей Дмитриев) [1929, драма, WEB-DLRip]",
            Quality::WebDLRip,
        ),
